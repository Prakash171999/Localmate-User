...
//        }
        ...
        public void OriginLocation(originLocation orgLocation){
                SharedPreferences originCoordinates = ctx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = originCoordinates.edit();
                editor.putString(KEY_OLATITUDE, orgLocation.getoLatitude());
                editor.putString(KEY_OLONGITUDE, orgLocation.getoLongitude());
                editor.apply();
            }


        public void DestinationLocation(destinationLocation destLocation){
            SharedPreferences destinationCoordinates = ctx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
...
//                    sharedPreferences.getString(KEY_ISADMIN, "isAdmin"))
//                    ;
//        }
